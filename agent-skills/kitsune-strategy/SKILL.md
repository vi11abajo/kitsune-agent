...
| 12 | `kitsune call strategy_set_metadata --args '{"vault":"0x..","strategyId":"3","name":"My DCA"}'` | Set display name |
| 13 | `kitsune call strategy_set_config --args '{"vault":"0x..","strategyId":"3","strategyType":"grid","gridLowerPrice":0.6,"gridUpperPrice":0.8,"gridCount":20,"gridType":"arithmetic"}'` | Set off-chain config (grid / recurring / entry indicators / trailing) |
| 14 | `kitsune call strategy_hide --vault <addr> --strategyId <id>` | Hide |
